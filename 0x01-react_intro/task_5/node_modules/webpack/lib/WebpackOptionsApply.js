...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\Sundra\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.358\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20b71ad8ed6748dc0ce0e3VxkIVUoIXwVVBAxdAVdVWgMJXAVT', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Sundra/.vscode/extensions/wallabyjs.console-ninja-1.0.358/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20b71ad8ed6748dc0ce0e3VxkIVUoIXwVVBAxdAVdVWgMJXAVT', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
		...
		compiler.resolverFactory.hooks.resolveOptions
			.for("context")
			.tap("WebpackOptionsApply", resolveOptions => {
				resolveOptions = cleverMerge(opt